...
namespace FinalReview
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // this is so the program does this when it starts
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // creates the URLs that the user will see when sorting through data
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute("namepagenum",
                    "TeamName/{teamname}/{team}/{pagenum}",
